...
function minMinMax(array) {
    ...
    const second = findSmallestPossible(array[0],array)
    return [array[0],second,array[array.length-1]]
}



const findSmallestPossible=(n,arr)=>{
    n+=1
    return !arr.find(el=>el===n)?n:findSmallestPossible(n,arr)
}